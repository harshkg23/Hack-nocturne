// ============================================================================
// SentinelQA — Notion Report Service
//
...
/**
 * Creates a structured Notion page inside the SentinelQA database.
 *
...
function buildPageBlocks(data: DebugReportInput): object[] {
  ...
  // ── Banner heading ─────────────────────────────────────────────────────────
  blocks.push(heading2(`🛡️ SentinelQA Debug Report`));
  ...
  // ── Footer ─────────────────────────────────────────────────────────────────
  blocks.push(divider());
  blocks.push(paragraph(`_Generated by SentinelQA at ${new Date().toISOString()}_`));
