// ============================================================================
// SentinelQA — Slack Notification Service
//
...
//   The webhook targets the #sentinelqa channel.
// ============================================================================

// Guard: this module reads secrets from process.env and must never be
// bundled into the browser. The server-only package enforces that at
// build time (throws if imported from a Client Component).
import "server-only";
...
export async function notifyPipelineStarted(
  ...
  const blocks: Block[] = [
    header("🚀 SentinelQA — Pipeline Started"),
    ...
    divider(),
    context("SentinelQA is generating a test plan and will execute tests via Playwright MCP."),
  ];
...
export async function notifyAgentTriggered(
  ...
  const blocks: Block[] = [
    header("🔍 SentinelQA — Agent Triggered"),
    ...
    divider(),
    context("SentinelQA is now generating a test plan and executing tests via Playwright MCP."),
  ];
...
export async function notifyTestsStarted(
  ...
  const blocks: Block[] = [
    header("⚡ SentinelQA — Tests Running"),
...
export async function notifyTestsPassed(
  ...
  const blocks: Block[] = [
    header("✅ SentinelQA — All Tests Passed"),
...
export async function notifyTestsFailed(
  ...
  const blocks: Block[] = [
    header("❌ SentinelQA — Tests Failed"),
...
export async function notifyPipelineError(
  ...
  const blocks: Block[] = [
    header("🚨 SentinelQA — Pipeline Error"),
